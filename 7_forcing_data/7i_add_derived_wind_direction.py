...
for file in all_files:
    ...
    with nc4.Dataset(file, 'r+') as f:
        ...
        if 'hru' in f.dimensions:
            f = cs.derive_wind_direction(f, u_wind='RDRS_v2.1_P_UUC_10m', v_wind='RDRS_v2.1_P_VVC_10m', dims='hru',       overwrite=True)
        else:
            f = cs.derive_wind_direction(f, u_wind='RDRS_v2.1_P_UUC_10m', v_wind='RDRS_v2.1_P_VVC_10m', dims='rlat/rlon', overwrite=True)
