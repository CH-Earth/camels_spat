#!/bin/bash
#SBATCH --job-name=rdrs_pet_units
...
#SBATCH --output=/gpfs/mdiops/globalhome/wmk934/HPC/camels_spat/7_forcing_data/slurm_logs/rdrs/7e_pet_unit_update/slurm-%A_%a.out
#SBATCH --array=0-1697
...
python 7e_fix_rdrs_pet_units.py $SLURM_ARRAY_TASK_ID