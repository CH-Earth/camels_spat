...
#SBATCH --output=//gpfs/mdiops/globalhome/wmk934/HPC/camels_spat/7_forcing_data/slurm_logs/rdrs/7b_subset/slurm-%A_%a.out
#SBATCH --array=484-515
...
python 7b_rdrs_to_basins.py $SLURM_ARRAY_TASK_ID $SLURM_TMPDIR