#!/bin/bash
#SBATCH --job-name=era5_subset_rr
#SBATCH --ntasks=1
...
#SBATCH --output=//gpfs/mdiops/globalhome/wmk934/HPC/camels_spat/7_forcing_data/slurm_logs/rerun_forcing/1d_subset_era5/slurm-%A_%a.out
#SBATCH --array=0-1697
