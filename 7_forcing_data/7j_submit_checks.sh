...
#SBATCH --output=//gpfs/mdiops/globalhome/wmk934/HPC/camels_spat/7_forcing_data/slurm_logs/rdrs/7j_checks/slurm-%A_%a.out
#SBATCH --array=0-1697
...
python 7j_rdrs_checks.py $SLURM_ARRAY_TASK_ID
