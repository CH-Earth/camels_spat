...
#SBATCH --output=//gpfs/mdiops/globalhome/wmk934/HPC/camels_spat/7_forcing_data/slurm_logs/rerun_forcing/2c_subset_emearth/slurm-%A_%a.out
#SBATCH --array=0-1697
...
python 2c_subset_EM_Earth_to_basins.py $SLURM_ARRAY_TASK_ID
