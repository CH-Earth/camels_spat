...
#SBATCH --output=/gpfs/mdiops/globalhome/wmk934/HPC/camels_spat/10_analysis/logs/pet_stats_1/slurm-%A_%a.out
#SBATCH --array=0-1697 
...
python 7a_compute_pet_stats.py $SLURM_ARRAY_TASK_ID