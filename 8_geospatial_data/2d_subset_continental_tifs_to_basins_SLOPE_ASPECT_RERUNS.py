...
data_files = [Path('/gpfs/tp/gwf/gwf_cmt/wknoben/camels_spat/geospatial_temp/merit/aspect/merit_hydro_aspect.tif'),
              Path('/gpfs/tp/gwf/gwf_cmt/wknoben/camels_spat/geospatial_temp/merit/slope/merit_hydro_slope.tif')]
