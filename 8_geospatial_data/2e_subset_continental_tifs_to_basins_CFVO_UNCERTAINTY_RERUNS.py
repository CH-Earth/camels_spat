...
data_files = [Path('/gpfs/tp/gwf/gwf_cmt/wknoben/camels_spat/geospatial_temp/soilgrids/raw/cfvo/cfvo_0-5cm_uncertainty.tif'),
              Path('/gpfs/tp/gwf/gwf_cmt/wknoben/camels_spat/geospatial_temp/soilgrids/raw/cfvo/cfvo_5-15cm_uncertainty.tif'),
              Path('/gpfs/tp/gwf/gwf_cmt/wknoben/camels_spat/geospatial_temp/soilgrids/raw/cfvo/cfvo_15-30cm_uncertainty.tif'),
              Path('/gpfs/tp/gwf/gwf_cmt/wknoben/camels_spat/geospatial_temp/soilgrids/raw/cfvo/cfvo_30-60cm_uncertainty.tif'),
              Path('/gpfs/tp/gwf/gwf_cmt/wknoben/camels_spat/geospatial_temp/soilgrids/raw/cfvo/cfvo_60-100cm_uncertainty.tif'),
              Path('/gpfs/tp/gwf/gwf_cmt/wknoben/camels_spat/geospatial_temp/soilgrids/raw/cfvo/cfvo_100-200cm_uncertainty.tif')]

# --- Processing
# Get the array index from the command-line argument
if len(sys.argv) != 2:
    print("Usage: python 2e_subset.py <array_index>")
    sys.exit(1)
else:
    ix = int(sys.argv[1])
