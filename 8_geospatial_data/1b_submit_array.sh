...
#SBATCH --output=/gpfs/mdiops/globalhome/wmk934/HPC/camels_spat/8_geospatial_data/soil_logs/slurm-%A_%a.out
#SBATCH --array=0-179
...
python 1b_soil.py $SLURM_ARRAY_TASK_ID > ./soil_logs/1b_RERUNS_{$SLURM_ARRAY_TASK_ID}.out
